...
package projectx.sk.com.tripbook.detail;
...
import projectx.sk.com.tripbook.viewmodel.ListItemViewModel;
...
Toast.makeText(this.getContext(),".....   detail fragment  ........",Toast.LENGTH_LONG).show();
        ...
        listItemViewModel.getListItemById(itemId).observe(this, new Observer<ListItem>() {
            ...
            public void onChanged(@Nullable ListItem listItem) {
                if (listItem != null) {
                    ...
                    message.setText("message="+listItem.getMessage());
